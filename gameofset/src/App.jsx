...
import EditDeckPanel from './components/EditDeckPanel';
...
function App() {
  const [windows, setWindows] = useState([
    ...
    {name: "Edit Deck Panel", isMinimized: false, isVisible: false},
  ...
  return (
    <>
      ...
      <div id="game-container">
        ...
        <EditDeckPanel cards={gameCards} isMinimized={windows[3].isMinimized} isVisible={windows[3].isVisible} onMinimize={onMinimize} onClose={onClose} onEditDeck={onNewGame}/>
